...
python3.9 -m venv /home/vyacheslavz/projects/labs/devops-capstone-project/.venv
...
#echo "source /home/vyacheslavz/projects/labs/devops-capstone-project/.venv/bin/activate" >> ~/.bashrc
echo "Configuring the developer environment..."
echo "# DevOps Capstone Project additions"
export GITHUB_ACCOUNT=vjaceslavs-zaicevs"
export PS1="\[\e]0;\u:\W\a\]${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u\[\033[00m\]:\[\033[01;34m\]\W\[\033[00m\]\$ "
source /home/vyacheslavz/projects/labs/devops-capstone-project/.venv/bin/activate

echo "Installing Python dependencies..."
source /home/vyacheslavz/projects/labs/devops-capstone-project/.venv/bin/activate && python3.9 -m pip install --upgrade pip wheel
source /home/vyacheslavz/projects/labs/devops-capstone-project/.venv/bin/activate && pip install -r requirements.txt
